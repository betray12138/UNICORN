...
def get_args(rest_args):
    ...
    parser.add_argument('--env-name', default='HalfCheetahDir-v0')
    ...
    parser.add_argument('--vf-lr', type=float, default=0.0003, help='learning rate for value network (default: 3e-4)')
    parser.add_argument('--agent-sac', default=True)   
    parser.add_argument('--c-lr', type=float, default=0.00004, help='dual critic learning rate (BRAC dual)')
    ...
    parser.add_argument('--generative-model-path', type=str, default=
        'logs/HalfCheetahDir-v0/generative__0__29_12_17_42_14/models/model100.pt')
    ...
    parser.add_argument('--encoder-model-path', type=str, default=
        'logs/HalfCheetahDir-v0/contrastive_generative__0__29_12_22_28_32/models/encoder900.pt',
        help='for pretrain encoder then train policy')
    ...
    parser.add_argument('--beta-encoder', default=0.01, type=float)
